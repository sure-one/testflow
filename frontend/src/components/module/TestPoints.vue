...
import { Plus, MagicStick, Edit, Delete, ArrowRight, Search } from '@element-plus/icons-vue'
...
async function generateTestPoints() {
  if (!hasRequirementPoints.value) {
    ElMessage.warning('请先生成需求点')
    return
  }
